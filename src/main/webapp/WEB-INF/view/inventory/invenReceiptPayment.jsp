...
<div id="totalPage">
	...
	<h3>재고수불부현황</h3>
	<br/><br/>
		<form class="row g-2" style="padding-top:30px;" id="invenForm" method="post" action='<c:url value="/invenSituation"/>'>
			<div class="col-md-6">
			...
			<div class="col-12">
				...
				<div style="display: flex; align-items: center;">
					<input
						...
						placeholder="창고검색" autocomplete="off"/>
					<input type='hidden' id='wareCdValue' name ="wareCd">
					<button id="wareSearchBtn"  type="button" class="btn searchBtn p-1"><i class="bi bi-search"></i></button>
					<span id='removeWare'></span>		
				</div>
			</div>
			<div class="col-12">
...
<script src='<c:url value="/resources/js/inventory/invenReceiptPayment.js"/>'></script>
