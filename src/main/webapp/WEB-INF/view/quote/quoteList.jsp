...
* ----------  ---------  -----------------
* 2023. 11. 8.   김도현       최초작성
* 2023. 11. 13.  김도현       상세조회 모달창 작성
* 2023. 11. 17.  김도현		상세조회 모달창 수정 및 담당자, 품목 모달창 추가
* 2023. 11. 21.  김도현		엑셀 다운로드 버튼 및 POI script 코드 추가
* 
...
<style>
     #quoteListDataTable th, #quoteListDataTable td.qteCd,
     #quoteListDataTable td.qteDate,
     #quoteListDataTable td.empNm,
     #quoteListDataTable td.itemNm,
     #quoteListDataTable td.comNm{
        text-align: center;
    }
			...
			<div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-bb1c70a1-6c4c-451a-80b8-972dfdd01aa8"
				id="dom-bb1c70a1-6c4c-451a-80b8-972dfdd01aa8">
					<div class="table-responsive scrollbar">
						<table class="table table-bordered table fs--1 mb-0" id="quoteListDataTable">
							<thead class="bg-200 text-900">
								<tr>
									<th class="qteCd text-center" style="width: 80px;">견적서코드</th>
									<th class="qteDate">견적서일자</th>
									<th class="comNm">거래처명</th>
									<th class="empNm">담당자</th>
									<th class="itemNm">품목</th>
									<th class="qteQty" style="width: 70px;">수량</th>
									<th class="qteUprc" style="width: 70px;">단가</th>
									<th class="qteAmount" style="width: 100px;">합계</th>
									<th class="qteStat">진행여부</th>
...
<script>
    function downloadExcel() {
        // JSP 페이지의 URL
        var downloadUrl = '/quote/downloadExcel';
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="quoteModalLabel">견적서 상세 정보</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" 
                aria-label="Close"></button>
            </div>
            <form action="/quote/quoteUpdate" id="quoteForm" action="post">
				<div class="table-responsive scrollbar">
