...
* ----------  ---------  -----------------
* 2023. 11. 21.   김도현       최초작성
* 2023. 11. 21.   김도현		 상세조회 모달창 작성
* 2023. 11. 21.   김도현		 상세조회 담당자, 품목 모달창 추가
...
<style>
     #relsListDataTable th, #relsListDataTable td.rdrecCd,
     #relsListDataTable td.rdrecDate,
     #relsListDataTable td.empNm,
     #relsListDataTable td.itemNm,
     #relsListDataTable td.comNm{
        text-align: center;
    }
			...
			<div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-bb1c70a1-6c4c-451a-80b8-972dfdd01aa8"
				id="dom-bb1c70a1-6c4c-451a-80b8-972dfdd01aa8">
					<div class="table-responsive scrollbar">
						<table class="table table-bordered table fs--1 mb-0" id="relsListDataTable">
							<thead class="bg-200 text-900">
								<tr>
									<th class="rdrecCd text-center" style="width: 100px;">출하지시코드</th>
									<th class="rdrecDate">일자</th>
									<th class="rdrecOutDate">납기일자</th>
									<th class="comNm">거래처명</th>
									<th class="empNm">담당자</th>
									<th class="itemNm">품목</th>
									<th class="rdrecQty">수량</th>
									<th class="rdrecUprc">단가</th>
									<th class="rdrecAmount">합계</th>
									<th class="rdrecStat">진행여부</th>
...
<script>
    function downloadExcel() {
        // JSP 페이지의 URL
        var downloadUrl = '/rels/downloadExcel';
	...
	<!-- 모달 -->
<div class="modal fade" id="relsModal" tabindex="-1" aria-labelledby="relsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <!-- 모달 내용 -->
            <div class="modal-header">
                <h5 class="modal-title" id="relsModalLabel">출하지시서 상세 정보</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" 
                aria-label="Close"></button>
            </div>
            <form action="/rels/relsUpdate" id="relsForm" action="post">
				<div class="table-responsive scrollbar">
