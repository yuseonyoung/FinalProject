...
<h1 style="margin-bottom:30px;">발주서 현황</h1>
<div id="totalPage">
	<div class="card mb-3 px-3" style="width: 100%; height: auto;">
		<form class="row g-2" style="padding-top:30px;" id="orderPlayCurrentForm" method="post" action='<c:url value="/orderPlay/current"/>'>
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<div id="empList" style="display: flex; align-items: center;">
					<div class="input-group">
					    <input class="form-control" id="findEmpNm" type="text" autocomplete="off" data-bs-target="#findEmpModal" data-bs-toggle="modal" placeholder="담당자검색"/>
					</div>
					<input type="hidden" name="empCd" id="findEmpCd">
					<button id="empSearchBtn" type="button" class="btn searchBtn p-1" data-bs-target="#findEmpModal" data-bs-toggle="modal"><i class="bi bi-search" data-bs-toggle="modal"></i></button>	
			...
			<div class="col-12">
				...
				<div id="itemList" style="display: flex; align-items: center;">
					<input class="form-control" id="findItemNm" type="text" autocomplete="off" data-bs-target="#itemWindow" data-bs-toggle="modal"
						placeholder="품목검색"/>
					<button id="itemSearchBtn"  type="button" class="btn searchBtn p-1" data-bs-target="#itemWindow" data-bs-toggle="modal"><i class="bi bi-search" data-bs-toggle="modal"></i></button>	
				</div>
...
<!-- 요청 상세 모달 -->
<div class="modal fade" id="orderPlayCurrnetModal" tabindex="-1"
	aria-labelledby="orderPlayCurrnetModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl">
		<div class="modal-content" style="width: 1200px; margin: 0 auto">
			<!-- 모달 내용 -->
			<div class="modal-header">
				<h5 class="modal-title" id="orderPlayCurrnetModalLabel">발주요청 상세 정보</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal"
					aria-label="Close"></button>
			</div>
...
<c:url value="/resources/js/orderPlay/orderPlayCurrent.js" var="urls" />
<script src="${urls}">
