				...
				<div >
					<table class="table table-bordered  fs--1 mb-0"
						...
						<thead class="bg-200 text-900">
							<tr>
								<th class="rdrecCd">출고예정코드</th>
								<th class="rdrecReceive">받는곳명</th>
								<th class="empCd">담당자명</th>
								<th class="itemNm">품목명</th>
								<th class="rdrecDate">납기일자</th>
								<th class="rdrecQty">출고에정수량합계</th>
								<th class="rdrecQty">진행상태</th>
							</tr>
						</thead>
						<tbody class="list">
...
<div class="modal fade" id="rmstWindow" tabindex="-1"
 ...
 <c:url value="/resources/js/scheduledStock/outScheduledStock.js" var="urls" />
