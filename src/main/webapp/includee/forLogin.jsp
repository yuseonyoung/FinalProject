			...
			<div class="row min-vh-100 flex-center g-0">
				<div class="col-lg-8 col-xxl-5 py-3 position-relative">
					<img class="bg-auth-circle-shape"
						src="/resources/falcon/public/assets/img/icons/spot-illustrations/bg-shape.png"
						alt="" width="250"><img class="bg-auth-circle-shape-2"
						src="/resources/falcon/public/assets/img/icons/spot-illustrations/shape-1.png"
						alt="" width="150">
								...
								<div class="col-md-5 text-center bg-card-gradient">
									<div class="position-relative p-4 pt-md-5 pb-md-7"
										...
										<div class="bg-holder bg-auth-card-shape"
											style="background-image: url(/resources/falcon/public/assets/img/icons/spot-illustrations/half-circle.png);">
										</div>
										<!--/.bg-holder-->
										...
										<div class="z-1 position-relative">
											<a
												...
												href="/resources/falcon/public/index.html">falcon</a>
											<p class="opacity-75 text-white">With the power of
												Falcon, you can now focus only on functionaries for your
												digital products, while leaving the UI design on us!</p>
										</div>
									</div>
									<div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
										<p class="text-white">
											Don't have an account?<br> <a
												...
												href="/resources/falcon/public/pages/authentication/card/register.html">Get
												started!</a>
										</p>
										<p
											class="mb-0 mt-4 mt-md-5 fs--1 fw-semi-bold text-white opacity-75">
											Read our <a class="text-decoration-underline text-white"
												href="#!">terms</a> and <a
												class="text-decoration-underline text-white" href="#!">conditions
											</a>
										</p>
									</div>
								</div>
									...
									<div class="p-4 p-md-5 flex-grow-1">
										...
										<form>
											...
											<div class="row flex-between-center">
												...
												<div class="col-auto">
													<a class="fs--1"
														href="/resources/falcon/public/pages/authentication/card/forgot-password.html">Forgot
														Password?</a>
												</div>
											</div>
											<div class="mb-3">
		...
		<div class="offcanvas-body scrollbar-overlay px-x1 h-100"
				...
				<div class="row gx-2">
					<div class="col-6">
						<input class="btn-check" id="themeSwitcherLight"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								...
								src="/resources/falcon/public/assets/img/generic/falcon-mode-default.jpg"
					...
					<div class="col-6">
						<input class="btn-check" id="themeSwitcherDark" name="theme-color"
							...
							class="hover-overlay mb-2 rounded d-block"><img
								class="img-fluid img-prototype mb-0"
								src="/resources/falcon/public/assets/img/generic/falcon-mode-dark.jpg"
			...
			<div class="d-flex justify-content-between">
				<div class="d-flex align-items-start">
					<img class="me-2"
						src="/resources/falcon/public/assets/img/icons/left-arrow-from-left.svg"
						width="20" alt="" />
					<div class="flex-1">
						<h5 class="fs-0">RTL Mode</h5>
						<p class="fs--1 mb-0">Switch your language direction</p>
						<a class="fs--1"
							href="/resources/falcon/public/documentation/customization/configuration.html">RTL
							Documentation</a>
					</div>
				</div>
			...
			<div class="d-flex justify-content-between">
				<div class="d-flex align-items-start">
					<img class="me-2"
						src="/resources/falcon/public/assets/img/icons/arrows-h.svg"
						width="20" alt="" />
					<div class="flex-1">
						<h5 class="fs-0">Fluid Layout</h5>
						<p class="fs--1 mb-0">Toggle container layout system</p>
						<a class="fs--1"
							href="/resources/falcon/public/documentation/customization/configuration.html">Fluid
							Documentation</a>
					</div>
				</div>
				<div class="form-check form-switch">
			...
			<div class="d-flex align-items-start">
				<img class="me-2"
					src="/resources/falcon/public/assets/img/icons/paragraph.svg"
					width="20" alt="" />
				<div class="flex-1">
					...
					<div>
						<select class="form-select form-select-sm"
							...
							<option value="vertical"
								data-page-url="/resources/falcon/public/modules/components/navs-and-tabs/vertical-navbar.html">Vertical</option>
							<option value="top"
								data-page-url="/resources/falcon/public/modules/components/navs-and-tabs/top-navbar.html">Top</option>
							<option value="combo"
								data-page-url="/resources/falcon/public/modules/components/navs-and-tabs/combo-navbar.html">Combo</option>
							<option value="double-top"
								data-page-url="/resources/falcon/public/modules/components/navs-and-tabs/double-top-navbar.html">Double
								Top</option>
						</select>
					</div>
				</div>
			...
			<p>
				<a class="fs--1"
					href="/resources/falcon/public/modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles">See
					Documentation</a>
			</p>
			<div class="btn-group d-block w-100 btn-group-navbar-style">
				<div class="row gx-2">
					<div class="col-6">
						<input class="btn-check" id="navbar-style-transparent"
							...
							src="/resources/falcon/public/assets/img/generic/default.png"
					...
					<div class="col-6">
						<input class="btn-check" id="navbar-style-inverted" type="radio"
							...
							class="img-fluid img-prototype"
							src="/resources/falcon/public/assets/img/generic/inverted.png"
					...
					<div class="col-6">
						...
						<label class="btn d-block w-100 btn-navbar-style fs--1"
							...
							class="img-fluid img-prototype"
							src="/resources/falcon/public/assets/img/generic/card.png" alt="" /><span
					...
					<div class="col-6">
						<input class="btn-check" id="navbar-style-vibrant" type="radio"
							...
							class="img-fluid img-prototype"
							src="/resources/falcon/public/assets/img/generic/vibrant.png"
			...
			<div class="text-center mt-5">
				<img class="mb-4"
					src="/resources/falcon/public/assets/img/icons/spot-illustrations/47.png"
					alt="" width="120" />
